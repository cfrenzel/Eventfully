...
namespace Eventfully.EFCoreOutbox
{
        ...
        where T : DbContext
    {
        ...
        /// <returns></returns>
        public Task Dispatch(string messageTypeIdentifier, byte[] message, MessageMetaData meta, IEndpoint2 endpoint = null, OutboxDispatchOptions options = null)
        {
            return this._addToContext(messageTypeIdentifier, message, meta, endpoint, options);
        }

        private Task _addToContext(string messageTypeIdentifier, byte[] message, MessageMetaData meta, IEndpoint2 endpoint = null, OutboxDispatchOptions options = null)
        {
